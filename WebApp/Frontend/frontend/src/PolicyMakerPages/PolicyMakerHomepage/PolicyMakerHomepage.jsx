            ...
            try {
              ...
              certificationsData.forEach((cert) => {
                compliance[cert.name] = activeCertifications.some(
                  (activeCert) => activeCert.name === cert.name || activeCert.id === cert.id
                );
              });
        ...
        <aside className="sidebar">
          ...
          <div className="filters">
            ...
            <button className={visibleTypes.manufacturer ? 'active' : ''} onClick={() => toggleType('manufacturer')}>
              <span className="icon manufacturer" /> Queijarias
            </button>
          ...
          {/* NOVO: Detalhes da empresa selecionada */}
          {selectedCompany && (
